...
$sql = "insert into $layouttable (`id`, `template`, `pagelayout`, `elementlayout`, `pagewidth`, `pageheight`, `position`, `x`, `y`, `w`, `h`) 
values ('0', '$template', '$pagelayout', '$elementlayout', '$pagewidth', '$pageheight', '$positionnumber', '$x', '$y', '$w', '$h')";

$layoutquerymy = mysqli_query($mysqlconnect, $sql);
if(!$layoutquerymy)
{
echo "$sql<br>";
}
